class Admin::FestivalsController < AdminController
  ...
  private
    ...
    def festival_params
      permitted_params = [:main_gallery_id, :resource_id, :weez_event_id, :title, :subtitle, :content, :final_gallery_id, :exergue, :aside_link_1_data, :aside_link_2_data, :aside_link_3_data, :event_link_data, :info_link_data, :social_block, :slug, :status, :retargeting_pixel_id, {:new_event_ids => []}, {:new_workshop_ids => []}]
