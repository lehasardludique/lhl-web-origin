class PartnersPage
  ...
  attr_accessor :base_line, :section_1, :section_1_ids, :section_2, :section_2_ids, :section_3, :section_3_ids
  ...
  def update(attributes={})
    ...
    result = success == 1 ? true : false
  end

  def save
    SingleData.partners_baseline.update(v: self.base_line)
    SingleData.partners_section_1.update(v: self.section_1)
    SingleData.partners_section_1_ids.update(v: self.section_1_ids)
    SingleData.partners_section_2.update(v: self.section_2)
    SingleData.partners_section_2_ids.update(v: self.section_2_ids)
    SingleData.partners_section_3.update(v: self.section_3)
    SingleData.partners_section_3_ids.update(v: self.section_3_ids)
  end
end 